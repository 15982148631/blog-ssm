...
import com.wyf.blog.ssm.config.CustomMapper;
...
/**
 * @ProjectName: JsonUtils
 * @Package: com.wyf.blog.ssm.utils
 * @ClassName: jackson工具类JsonUtils
...
public class JsonUtils {
    ...
    public static Map<String, Object> json2mapDeeply(String json) throws Exception {
        return json2MapRecursion(json, MAPPER);
    }
    ...
    public static <T> List<T> json2list(String jsonArrayStr, Class<T> clazz) throws Exception {
        ...
        List<T> list = (List<T>) MAPPER.readValue(jsonArrayStr, javaType);
        return list;
    }
